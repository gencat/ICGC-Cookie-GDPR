...
class Popup {
	...
	constructor(options: Object, statusList: Object){
		...
		let cookiePopup = this.options.window.replace('{{classes}}', this.getPopupClasses.call(this).join(' '))
	...
	getPopupClasses() {
		...
		const didAttach = this.attachCustomPalette.call(this, this.options.palette);
